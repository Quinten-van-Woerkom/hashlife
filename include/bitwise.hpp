 ...
 */
template <typename... T>
using requires_unsigned =
    std::enable_if_t<std::conjunction_v<std::is_unsigned<T>...>>;
...
constexpr auto full_add(Unsigned1 left, Unsigned2 right,
                        Unsigned3 carry) noexcept {
